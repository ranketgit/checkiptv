        ...
        <div className="flex lg:flex-row flex-col items-center -mx-4 justify-center lg:text-left text-center">
          <div className="w-full lg:w-1/2 px-4 mb-12 lg:mb-0">
            <div className="flex flex-col">
              ...
              <h2 className=" text-2xl  sm:text-3xl 2xl:text-4xl font-bold tracking-normal text-secondaryColor">
              Instant Access Worldwide Sky Sports & Netflix Shows 
              </h2>
            </div>
          </div>
          <div className="w-2/3 sm:w-[620px] lg:w-1/2 mx-auto lg:mx-0 lg:pl-10">
            <div className="flex flex-wrap -m-4">
              <div className="w-1/2 sm:w-1/3 py-6 flex justify-center">
                <img src="logos/amazon-prime.png"/>
              </div>
              <div className="w-1/2 sm:w-1/3 py-6 flex  justify-center">
              <img src="logos/bbc-news.png"/>
              </div>
              <div className="w-1/2 sm:w-1/3 py-6 flex  justify-center">
              <img src="logos/bein-sport.png"/>
              </div>
              <div className="w-1/2 sm:w-1/3 py-6 flex justify-center">
              <img src="logos/canal-plus.png"/>
              </div>

              <div className="w-1/2 sm:w-1/3 py-6 flex justify-center">
              <img src="logos/hulu.png"/>
              </div>
              <div className="w-1/2 sm:w-1/3  py-6 flex  justify-center">
